#ifndef _ExpressLRS_FHSS_H_
#define _ExpressLRS_FHSS_H_

extern volatile uint8_t ExpressLRS_FHSSptr;

extern uint8_t ExpressLRS_NumOfFHSSfrequencies;
...
extern uint8_t ExpressLRS_FHSSsequence[NR_SEQUENCE_ENTRIES];
